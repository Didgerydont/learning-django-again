...
<head>
    ...
    <title>Coverage for /workspace/.pip-modules/lib/python3.7/site-packages/django/contrib/admin/migrations/__init__.py: 100%</title>
...
<div id="header">
    <div class="content">
        <h1>Coverage for <b>/workspace/.pip-modules/lib/python3.7/site-packages/django/contrib/admin/migrations/__init__.py</b> :
