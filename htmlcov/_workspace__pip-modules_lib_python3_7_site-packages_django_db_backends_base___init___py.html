...
<head>
    ...
    <title>Coverage for /workspace/.pip-modules/lib/python3.7/site-packages/django/db/backends/base/__init__.py: 100%</title>
...
<div id="header">
    <div class="content">
        <h1>Coverage for <b>/workspace/.pip-modules/lib/python3.7/site-packages/django/db/backends/base/__init__.py</b> :
